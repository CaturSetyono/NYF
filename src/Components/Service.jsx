...
const Service = () => {
  return (
    <div className="border-t-2 border-gray-800 min-h-screen flex flex-col justify-center items-center bg-gray-950 text-white  text-center">
      ...
      <div className="flex flex-col md:flex-row max-w-5xl w-full p-8 gap-12 justify-between items-center relative z-10">
        {/** Card 1 */}
        <div className="group flex-1 rounded-3xl backdrop-blur-md bg-white/10 border border-white/20 shadow-xl p-6 transform transition-all duration-300 hover:scale-105 hover:backdrop-blur-lg hover:bg-white/20">
          ...
          <p className="text-sm md:text-base text-white/80 group-hover:text-white transition-all duration-300 text-justify">
            We offer Paid Promotion to advertise your products or services with
            affordable pricing and great benefits.
          </p>
          <a
            href="/get-started"
        ...
        <div className="group flex-1 rounded-3xl backdrop-blur-md bg-white/10 border border-white/20 shadow-xl p-6 transform transition-all duration-300 hover:scale-105 hover:backdrop-blur-lg hover:bg-white/20">
          ...
          <p className="text-sm md:text-base text-white/80 group-hover:text-white transition-all duration-300 text-justify">
            We provide Affiliate Promotions to help advertise your products or
            services with high value at low costs.
          </p>
          <a
            href="/get-started"
        ...
        <div className="group flex-1 rounded-3xl backdrop-blur-md bg-white/10 border border-white/20 shadow-xl p-6 transform transition-all duration-300 hover:scale-105 hover:backdrop-blur-lg hover:bg-white/20">
          ...
          <p className="text-sm md:text-base text-white/80 group-hover:text-white transition-all duration-300 text-justify">
            We offer Endorsements to promote your products or services with
            affordable yet valuable promotion options.
          </p>
          <a
            href="/get-started"
